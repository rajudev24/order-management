...
const ProductAddEditPopup = ({ itemId, refreshDataTable, ...props }) => {
  ...
  const handleSubmitProduct = async (data) => {
    try {
      if (itemId) {
        ...
        successStack("Update Product Successfully", "success");
      } else {
        await createProduct(data);
        successStack("Product Added Successfully", "success");
      }
  ...
  return (
    <HookFormMuiModal
      ...
      title={
        <>
          <Person />
          {isEdit ? "Product Edit" : "Add New Product"}
        </>
      }
      maxWidth={"lg"}
...
export default ProductAddEditPopup;
